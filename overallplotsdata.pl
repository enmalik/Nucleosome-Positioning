...
open (writefileScatter, ">".$statsDirectory."/scatter-plot-data.txt");
open (writefileScatterColour, ">".$statsDirectory."/scatter-plot-data-colour.txt");

#check cluster colour file
my $colourbarFile = 'stats/heatmap-cluster-colours.txt';
